...
- `crates/systemdiff-core/src/lib.rs` and `crates/systemdiff-windows/src/registry.rs` only for equivalent current-stable Clippy compatibility fixes discovered by remote CI
